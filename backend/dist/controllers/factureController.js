        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!req.body.errors) {
                    ...
                    const resp = yield gestion_facture_1.GestionFacture.create({ idCommande: idCommande, idArtice: idArticles, statut: statut, date: null });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!req.body.errors) {
                    ...
                    const resp = yield gestion_commande_1.GestionCommande.changeStatus(status, commandeId);
                    if (status == "payé") {
                    }

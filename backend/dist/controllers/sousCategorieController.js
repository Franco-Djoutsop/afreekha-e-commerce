    ...
    addsousCategorie(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const idCat = yield categorie_1.default.findByPk(idCategorie);
                if (idCat) {
                    if (nom != null) {
                        const datas = yield SousCategorie_1.default.create({
    ...
    updateSousCategorie(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield SousCategorie_1.default.update({ nom: data.nom, idCategorie: data.idCategorie }, {
                    where: {
                        idSousCategorie: id,
                    },
                });

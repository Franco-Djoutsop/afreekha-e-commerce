...
//categorie
routerAdmin.post("/categorie", crypto_js_1.crypt.decode, validation_2.addcategorie, categorieController_1.default.addCategorie);
...
routerAdmin.put("/sousCategorie/:id", crypto_js_1.crypt.decode, validation_2.updatesousCategorie, sousCategorieController_1.default.updateSousCategorie);
...
routerAdmin.get("/home/:offset", homeController_1.HomeController.getHomeAdminData);
routerAdmin.post("/article", 
// validateToken,
// crypt.decode,;
validation_1.createArticleValidation, articleController_1.ArticleController.create);
...
routerAdmin.route("/users/:id").patch(crypto_js_1.crypt.decode, userControler_1.updateUsers);
